...
const PredictPlantDisease = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundImage: "url('https://wallpapercave.com/wp/wp2139158.jpg')" ,backgroundPosition:"no-repeat" ,backgroundSize:"cover" }}>
  ...
  <h1 style={{ color: "black" }}>You have a healthy plant!!..</h1>
                        ...
                        <>
                          <p className="h1 fw-bold text-danger text-center"><h1 style={{ color: "red" }}><b>
  Oops!! Plant detected with a disease: </b>
</h1>
 : {result.className}</p>
                    ...
                    {loadedImage && (
                      <button className="btn btn-primary mt-5" onClick={predictFromImage}  style={{backgroundColor:"blueviolet"}}>
                        Predict Disease
                      </button>
                    )}
                  </div>
